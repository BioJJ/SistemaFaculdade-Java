...
public class tela_matricula extends Telas implements ActionListener, KeyListener {
	...
	JLabel pesq_bolsa = new JLabel("psquisar Bolsa");
	...
	public void criarTela() {
		...
		txt_cod.setBounds(10, 40, 100, 30);
	...
	public static void main(String[] args) {
		...
		tela_matricula tela_cad_curso = new tela_matricula();
	...
	public void salvar() {
		...
		matricula.setCodigo(Integer.parseInt(txt_cod.getText()));
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		if( e.getKeyCode() == KeyEvent.VK_ENTER && e.getSource()== txt_pesq_aluno){ 
		...
		} if(e.getKeyCode() == KeyEvent.VK_ENTER && e.getSource()== txt_pesq_bolsa){ 
		...
		} if(e.getKeyCode() == KeyEvent.VK_ENTER && e.getSource()== txt_pesq_curso){ 
			if(txt_pesq_curso.getText().equals("")) {
				JOptionPane.showMessageDialog(null, "Campo vazio");
